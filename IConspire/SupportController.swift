...
class SupportController {
    ...
    func saveSupport(supportTitle: String, supportSubTitle: String, supportSource: String, supportAuthor: String, supportDate: Date, supportBody: String, supportLatitude: Double, supportLongitude: Double, project: Project, supportImageData: Data, completion: @escaping(Support?) -> Void) {
        ...
        let support = Support(supportTitle: supportTitle, supportSubTitle: supportSubTitle, supportSource: supportSource, supportAuthor: supportAuthor, supportDate: supportDate, supportBody: supportBody, supportLatitude: supportLatitude, supportLongitude: supportLongitude, projectReference: projectReference, supportImageData: supportImageData)
